...
En la implementación recorreremos los arreglos de vértices y caras para almacenarlos en la malla durante la inicialización, para luego en cada `Update` generar los triángulos, guardarlos en la cola `triangles` y transformarlos. Para finalmente renderizadores en `Render` una vez ya están proyectados:
